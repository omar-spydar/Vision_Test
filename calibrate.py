...
''' This program Performs camera calibration using a chessboard.'''
 
from __future__ import print_function # Python 2/3 compatibility 
import cv2 # Import OpenCV library to enable computer vision
import numpy as np # Import NumPy scientific computing library
...
number_of_squares_X = 10 # Number of chessboard squares along x-axis
number_of_squares_Y = 7  # Number of chessboard squares along y-axis
...
def main():
  ...
  for image_file in images:
    ...
    # If corners are found by algorithm, draw them
    if success == True:
      ...
      # Display window for a short period. Used for testing.
      cv2.waitKey(1000) 
                                                                                                                      
  # Perform camera calibration to return camera matrix, distortion coefficients, rotation and translation vectors etc 
  ...
  # Display key parameter outputs of camera calibration process
  print("Camera matrix:") 
  print(mtx) 
